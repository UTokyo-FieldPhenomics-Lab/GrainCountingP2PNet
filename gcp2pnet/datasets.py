...
def get_dataset_convert_arguments():
    ...
    parser.add_argument('--test_image_folder', default=None, help="the folder contains images for generating testing data")
    parser.add_argument('--test_label_folder', default=None, help="the folder contains labels for generating testing data")
